...
if [[ ${WARDEN_SELENIUM} -ne 1 ]] || [[ ${WARDEN_SELENIUM_DEBUG} -ne 1 ]]; then
  fatal "Your environment is not configured with WARDEN_SELENIUM or WARDEN_SELENIUM_DEBUG"
fi
...
echo $'We are running connection for you. Password is \"\e[1msecret\"\e[0m'
